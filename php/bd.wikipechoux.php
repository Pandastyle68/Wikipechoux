...
//Madeleines
function getMadeleine() { // Retourne toutes les madeleines
    $resultat = array();
...
//Mots
function getMots() { // Retourne tous les mots
    $resultat = array();
...
*/ 
function getMotLettre($lettre) { // Retourne les mots qui commencent par certaines lettres
    $resultat = array();
...
function getIdByMot($mot) { // Obtient l'id d'un mot à partir de ce mot
    $resultat = array();
...
function getMotByOrdreAlpha($lettre) { // Obtient les mots possédant à leur début certaines lettres et les tri par ordre alphabétique
    $resultat = array();

    try {
        $cnx = connexionPDO();
        $req = $cnx->prepare("select id,nom_mot from mot where nom_mot like CONCAT(:lettre, '%') order by nom_mot asc");
        $req->bindParam(':lettre',$lettre,PDO::PARAM_STR);
        $req->execute();
...
function getMotById($id) { // Obtient un mot à partir de son id
    $resultat = array();
...
function getImageMot($id) { // Obtient les images associées à un mot
    $resultat = array();
...
function getVideoMot($id) { // Obtient les vidéos associées à un mot
    $resultat = array();

    try {
        $cnx = connexionPDO();
        $req = $cnx->prepare("select nom_video from video where id_mot =  :id");
        $req->bindParam(':id',$id,PDO::PARAM_INT);
        $req->execute();
...
function getMotAlea() { // Obtient l'id d'un mot aléatoirement
    $resultat = array();
