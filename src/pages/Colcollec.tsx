      ...
      <IonContent fullscreen>
        ...
        <div>
          ...
          <Swiper modules={[Autoplay, Keyboard, Pagination, Scrollbar, Zoom]} autoplay={true}
            ...
            loop={true}>
            <SwiperSlide>
              <img src="assets/divers/collectionCollectionneur.jpg" alt="Collection de collectionneur"></img>
            </SwiperSlide>
            <SwiperSlide>
              <img src="assets/divers/collectionCollectionneur2.jpg" alt="Collection de collectionneur 2"></img>
            </SwiperSlide>
          </Swiper>
          <hr></hr>
        </div>
