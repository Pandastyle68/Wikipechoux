      ...
      <IonContent fullscreen>
        ...
        <div>
          ...
          <Swiper modules={[Autoplay, Keyboard, Pagination, Scrollbar, Zoom]} autoplay={true}
            ...
            loop={true}>
            <SwiperSlide>
              <img src="assets/divers/jeupelerinage.jpg" alt="Jeu du pelerinage"></img>
            </SwiperSlide>
            <SwiperSlide>
            <img src="assets/divers/jeupelerinage1.jpg" alt="Jeu du pelerinage 2"></img>
            </SwiperSlide>
          </Swiper>
          <hr></hr>
        </div>
