      ...
      <IonContent fullscreen>
        ...
        <div>
          ...
          <Swiper modules={[Autoplay, Keyboard, Pagination, Scrollbar, Zoom]} autoplay={true}
            ...
            loop={true}>
            <SwiperSlide>
              <img src="assets/divers/jeuTetesBrulees.jpg" alt="Jeu des tetes brulées"></img>
            </SwiperSlide>
            <SwiperSlide>
            <img src="assets/divers/jeuTetesBrulees2.jpg" alt="Jeu des tetes brulées 2"></img>
            </SwiperSlide>
          </Swiper>
          <hr></hr>
        </div>
