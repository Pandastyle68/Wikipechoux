      ...
      <IonContent fullscreen>
        ...
        <div>
          ...
          <Swiper modules={[Autoplay, Keyboard, Pagination, Scrollbar, Zoom]} autoplay={true}
            ...
            loop={true}>
            <SwiperSlide>
              <img src="assets/divers/lexiqueMaladies.jpg" alt="Lexique des maladies"></img>
            </SwiperSlide>
            <SwiperSlide>
              <img src="assets/divers/lexiqueMaladies2.jpg" alt="Lexique des maladies 2"></img>
            </SwiperSlide>
          </Swiper>
          <hr></hr>
        </div>
