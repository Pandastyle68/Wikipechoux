      ...
      <IonContent fullscreen>
        ...
        <div>
          ...
          <Swiper modules={[Autoplay, Keyboard, Pagination, Scrollbar, Zoom]} autoplay={true}
            ...
            loop={true}>
            <SwiperSlide>
              <img src="assets/divers/lexiqueMer.jpg" alt="Lexique de la mer"></img>
            </SwiperSlide>
            <SwiperSlide>
              <img src="assets/divers/lexiqueMer2.jpg" alt="Lexique de la mer 2"></img>
            </SwiperSlide>
          </Swiper>
          <hr></hr>
        </div>
