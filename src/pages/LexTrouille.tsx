      ...
      <IonContent fullscreen>
        ...
        <div>
          ...
          <Swiper modules={[Autoplay, Keyboard, Pagination, Scrollbar, Zoom]} autoplay={true}
            ...
            loop={true}>
            <SwiperSlide>
              <img src="assets/divers/lexiqueTrouillometre.jpg" alt="Lexique trouille"></img>
            </SwiperSlide>
            <SwiperSlide>
              <img src="assets/divers/lexiqueTrouillometre2.jpg" alt="Lexique trouille 2"></img>
            </SwiperSlide>
          </Swiper>
          <hr></hr>
        </div>
