      ...
      <IonContent fullscreen>
        ...
        <div>
          ...
          <Swiper modules={[Autoplay, Keyboard, Pagination, Scrollbar, Zoom]} autoplay={true}
            ...
            loop={true}>
            <SwiperSlide>
              <img src="assets/divers/mementoAffixes.jpg" alt="mementoAffixes"></img>
            </SwiperSlide>
            <SwiperSlide>
              <img src="assets/divers/mementoAffixes2.jpg" alt="mementoAffixes 2"></img>
            </SwiperSlide>
          </Swiper>
          <hr></hr>
        </div>
