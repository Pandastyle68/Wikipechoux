      ...
      <IonContent fullscreen>
        ...
        <div>
          ...
          <Swiper modules={[Autoplay, Keyboard, Pagination, Scrollbar, Zoom]} autoplay={true}
            ...
            loop={true}>
            <SwiperSlide>
              <img src="assets/divers/tableauMesures.jpg" alt="Tableau des mesures"></img>
            </SwiperSlide>
            <SwiperSlide>
            <img src="assets/divers/tableauMesures2.jpg" alt="Tableau des mesures 2"></img>
            </SwiperSlide>
            <SwiperSlide>
            <img src="assets/divers/tableauMesures3.jpg" alt="Tableau des mesures 3"></img>
            </SwiperSlide>
          </Swiper>
          <hr></hr>
        </div>
