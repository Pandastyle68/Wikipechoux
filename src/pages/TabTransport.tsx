      ...
      <IonContent fullscreen>
        ...
        <div>
          ...
          <Swiper modules={[Autoplay, Keyboard, Pagination, Scrollbar, Zoom]} autoplay={true}
            ...
            loop={true}>
            <SwiperSlide>
              <img src="assets/divers/TableauTransports.jpg" alt="Tableau des transports"></img>
            </SwiperSlide>
            <SwiperSlide>
            <img src="assets/divers/TableauTransports2.jpg" alt="Jeu du pelerinage 2"></img>
            </SwiperSlide>
          </Swiper>
          <hr></hr>
        </div>
